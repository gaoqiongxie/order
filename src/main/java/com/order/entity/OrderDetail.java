...
public class OrderDetail {
    ...
    /**
     * 租期单位, 月,10;周,20;日,30;台班,40;季,50;年,60;平方,70;立方,80;吨,90;根,100;延米,110;米,120
     */
    ...
    /**
     * 计价方式, 月价格,10;周价格,20;日价格,30;季价格,50;年价格,60;按台班,120;按平方,130;按立方,160;按吨,170;根,180;延米,190;米,200
     */
    ...
    /**
     * 租期单位, 月,10;周,20;日,30;台班,40;季,50;年,60;平方,70;立方,80;吨,90;根,100;延米,110;米,120
     * @return lease_unit 租期单位, 月,10;周,20;日,30;台班,40;季,50;年,60;平方,70;立方,80;吨,90;根,100;延米,110;米,120
     */
    ...
    /**
     * 租期单位, 月,10;周,20;日,30;台班,40;季,50;年,60;平方,70;立方,80;吨,90;根,100;延米,110;米,120
     * @param leaseUnit 租期单位, 月,10;周,20;日,30;台班,40;季,50;年,60;平方,70;立方,80;吨,90;根,100;延米,110;米,120
     */
    ...
    /**
     * 计价方式, 月价格,10;周价格,20;日价格,30;季价格,50;年价格,60;按台班,120;按平方,130;按立方,160;按吨,170;根,180;延米,190;米,200
     * @return price_mode 计价方式, 月价格,10;周价格,20;日价格,30;季价格,50;年价格,60;按台班,120;按平方,130;按立方,160;按吨,170;根,180;延米,190;米,200
     */
    ...
    /**
     * 计价方式, 月价格,10;周价格,20;日价格,30;季价格,50;年价格,60;按台班,120;按平方,130;按立方,160;按吨,170;根,180;延米,190;米,200
     * @param priceMode 计价方式, 月价格,10;周价格,20;日价格,30;季价格,50;年价格,60;按台班,120;按平方,130;按立方,160;按吨,170;根,180;延米,190;米,200
     */
